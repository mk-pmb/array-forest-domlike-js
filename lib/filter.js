...
module.exports = (function setup() {
  ...
  EX = function filterWoods(list, opt, overrides) {
    ...
    list.forEach(function (wood, origIdx) {
      ...
      rslt.had += 1;
      if (opt.nthResult && (rslt.had !== opt.nthResult)) { return; }
    ...
    if (opt.justCount) { return rslt.had; }
    if (opt.nthResult) {
  ...
  EX.checkOpts = function (opt, wood) {
    ...
    if (!EX.checkVal.props(opt.attrib, wood)) { return false; }
  };
  ...
  EX.checkVal.props = function (expect, actual) {
    return ((!expect) || Object.keys(expect).reduce(function (prev, key) {
